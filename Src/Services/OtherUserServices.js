import { IS_LOADING, SET_ALL_POST, SET_BLOCK_USER_LIST, SET_LIKED_USER_LIST, SET_LIKE_DISLIKE, UPDATE_BLOCK_LIST, UPDATE_POST_LIST } from "../Redux/ActionTypes";
...
export const onConnectRequest = (request) =>
    async dispatch => {
...
export const onUnFollowRequest = (request) =>
    async dispatch => {
        return makeAPIRequest({
            method: POST,
...
export const onBlockUserApi = (request) =>
    async dispatch => {
            ...
            .then(async (response) => {
                handleSuccessRes(response, request, dispatch, () => {
                    ...
                    if (request?.data?.action == 'block') {
                        dispatchAction(dispatch, UPDATE_POST_LIST, { ...request?.data, type: 'block' })
                    } else {
...
export const onGetBlockUserList = (request) =>
    async dispatch => {
        dispatchAction(dispatch, IS_LOADING, true)
        return makeAPIRequest({
            method: GET,
