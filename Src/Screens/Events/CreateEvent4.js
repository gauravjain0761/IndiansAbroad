            ...
            <KeyboardAwareScrollView >
                <View style={{ paddingHorizontal: wp(16) }}>
                    ...
                    <View style={styles.row}>
                        ...
                        <Text style={[styles.des]}>I agree <Text style={{ color: colors.primary_500 }}>Event Guidelines</Text> of IndiansAbroad.</Text>
                    </View>
                </View>
                <View style={[styles.blueView]}>
                    <CommonButton onPress={() => navigation.navigate(screenName.homeScreen)} title={'Create'} extraStyle={{ width: 140, height: 45 }} />
                </View>
            </KeyboardAwareScrollView>
        </SafeAreaView>
    )
