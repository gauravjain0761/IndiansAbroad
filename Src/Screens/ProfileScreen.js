            ...
            <ScrollView>
                ...
                <View style={styles.tabMainView}>
                    <TouchableOpacity
                        ...
                        <Text style={FontStyle(fontname.actor_regular, 14, tabSelection == 'POST' ? colors.primary_6a7e : colors.neutral_900,)}>
                            {'My Posts (10)'}
                        </Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        ...
                        <Text style={FontStyle(fontname.actor_regular, 14, tabSelection == 'INDIANS' ? colors.primary_6a7e : colors.neutral_900,)}>
                ...
                <PagerView
                    ...
                    onPageSelected={e => {
                        setTabSelection(
                            e?.nativeEvent?.position == 0 ? 'POST' : 'INDIANS',
                        );
