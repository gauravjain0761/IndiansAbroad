...
export default function IndiansPage() {
  ...
  //   let obj = {
  //     data: { emails: [], search: '', userId: user?._id, page: page, limit: 0, },
  //   };
  //   dispatch(getallIndianUser(obj));
  // };
  // const getPagesList = page => {
  //   let obj = {
  //     params: { page: page, userId: user?._id, searchText: '', },
  //   };
  ...
  //   setSearchText(text)
  //   let obj = {
  //     data: { emails: [], search: text, userId: user?._id, page: 1, limit: 0, },
  //   };
  //   dispatch(getallIndianUser(obj));
  // }
  ...
  //   let obj = {
  //     params: { page: 1, userId: user?._id, searchText: text, },
  //   };
  //   dispatch(getallPagesUser(obj));
  // };
...
//           <Text style={styles.peopleText}> {'People you may know'}</Text>
