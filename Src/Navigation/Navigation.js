...
function MyTabs() {
  return (
    <Tab.Navigator tabBar={props => <MyTabbar {...props} />}
      ...
      <Tab.Screen options={({ navigation }) => ({ ...headerStyleTransparent, title: 'Home' })} name={screenName.homeScreen} component={HomeScreen} />
      <Tab.Screen options={({ navigation }) => ({ ...headerStyleTransparent, title: 'Indians' })} name={screenName.indiansPage} component={IndiansPage} />
      <Tab.Screen options={({ navigation }) => ({ ...headerStyleTransparent, title: 'Discussion' })} name={screenName.discussionForum} component={DiscussionForum} />
      <Tab.Screen options={({ navigation }) => ({ ...headerStyleTransparent, title: 'Chatbox' })} name={screenName.chatScreen} component={ChatScreen} />
      <Tab.Screen options={({ navigation }) => ({ ...headerStyleTransparent, title: 'Profile' })} name={screenName.profileScreen} component={ProfileScreen} />
    </Tab.Navigator>
  );
}
